...
function light(){
    ...
    document.querySelector("#intro").style.backgroundImage = "linear-gradient(145deg, #3D5DC2 20%, #647DCE 100%)"
...
function dark(){
    ...
    document.querySelector("#intro").style.backgroundImage = "linear-gradient(145deg, #1A2A6C 0%, #4A0E6E 100%)"
    darkcard.forEach(card => {
        card.style.background = "linear-gradient(180deg, #202b3a 0%, #1a222e 100%)"
